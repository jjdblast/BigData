...
static {
    ...
    conf.set("hbase.zookeeper.quorum", "ubt202:2181,ubt204:2181,ubt203:2181");
}
...
public static void main(String[] args) {
    try {
        String tableName = "TEST_COUNT_HBASE_SPEED";
        // 第一步：创建数据库表：“student”
        ...
        if (isExist(tableName)) {
	          ...
	          for(int i=0;i<100000;i++){
		          ...
		          HBaseJavaAPI.addRow(tableName, rowkey, "info", "name", "wzt"+i);  
	        	  HBaseJavaAPI.addRow(tableName, rowkey, "info", "age", r.nextInt(50)+"");  
	              HBaseJavaAPI.addRow(tableName, rowkey, "info", "sex", r.nextInt(1)+"");  
	              HBaseJavaAPI.addRow(tableName, rowkey, "course", "china", r.nextInt(100)+"");  
	              HBaseJavaAPI.addRow(tableName, rowkey, "course", "math", r.nextInt(100)+"");  
	              HBaseJavaAPI.addRow(tableName, rowkey, "course", "english", r.nextInt(100)+"");    
	          }
